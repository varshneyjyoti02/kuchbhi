...
$JAVA_CMD $JAVA_OPTS "-Dtcs.version=3.2.8.RELEASE"  "-Dtcs.edition=developer" "-Djava.util.logging.config.file=$CONF_DIR/commons-logging.properties" "-Druntime.directory=$RUNTIME_DIR" "-Ddefault.instance.directory=$INSTANCE_DIR" -classpath "$CLASSPATH" com.springsource.tcruntime.instance.TcRuntimeAdmin "$@"
EXIT_CODE=$?
